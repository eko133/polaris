...
from util.mass_calibration import generate_possible_formula
from util.mass_calibration import mp_align_with_recalibration
...
compound = generate_possible_formula(375,525)
...
with concurrent.futures.ProcessPoolExecutor() as executor:
    data_dict[0], data_dict[1],data_dict[2],data_dict[3],data_dict[4], data_dict[5],data_dict[6],data_dict[7] =executor.map(mp_align_with_recalibration, args)
for i in range(0,n_proc):
